...
const { LAYOUT, COLOR, LocalizationContext } = require("../constants")
            ...
            return (
                <react_native_1.View style={styles.paginationContainer}>
                    ...
                    <react_native_1.TouchableOpacity style={styles.policyButton} onPress={() => this.props.navigate()}>
                        <react_native_1.Text style={styles.policyButtonText}>{this.context.t('Privacy Policy')}</react_native_1.Text>
                    </react_native_1.TouchableOpacity>
                </react_native_1.View>
            )
        }
